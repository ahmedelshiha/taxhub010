/**
 * TaskQuickCreateModal Component - Quick task creation
 * 
 * Features:
...
import { TaskPriority, TaskCreateInput } from "@/types/shared/entities/task";
...
/**
 * TaskQuickCreateModal Component
 */
export function TaskQuickCreateModal({
    ...
    const [formData, setFormData] = useState<TaskCreateInput>({
        ...
        complianceRequired: defaultValues?.complianceRequired || false,
    });
    ...
    return (
        <FormModal
            ...
            description="Create a task to track work and stay organized"
            size="md"
        ...
        >
            <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="task-compliance" className="font-normal cursor-pointer">
                        This task requires compliance tracking
                    </Label>
                </div>

                {/* Compliance Deadline (shown only if compliance is required) */}
                        ...
                        <Input
                            ...
                            value={
                                formData.complianceDeadline
                                    ? new Date(formData.complianceDeadline).toISOString().split("T")[0]
                                    : ""
                            }
                            onChange={(e) => {
